const Footer = () => {
  return (
    <footer className="relative w-full bg-black/40">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex items-center gap-2">
              <img src="/logo.png" alt="Spectra Pi Logo" className="h-7 w-auto" />
            </div>
          ...
          <div className="flex flex-wrap items-center gap-6 md:gap-10">
            <a href="#" className="text-white text-sm font-medium hover:text-blue-400 transition-colors uppercase tracking-wide">
              Features
            </a>
            <a href="#" className="text-white text-sm font-medium hover:text-blue-400 transition-colors uppercase tracking-wide">
              Services
